...
sim1_plots
infected_new(infected_person_stats)
```
...
##Simulation 1: Correlation Analysis
```{r}
...
anova_model <- aov(Total.Deaths ~ as.integer(timeStep), data = overall_stats_with_clustering)
summary(anova_model)
```
